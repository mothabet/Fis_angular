...
export class SharedOneYearWithPartsAndTotalComponent {
  ...
  constructor(private route: ActivatedRoute, private sectorsAndActivitiesServices: SectorAndActivitiesService, private formServices: FormService,
    private sharedServices: SharedService, private auditRuleHomeService: AuditRuleHomeService, 
    private companyServices: CompanyHomeService,private authService: LoginService) {
  }
  ngOnInit() {
