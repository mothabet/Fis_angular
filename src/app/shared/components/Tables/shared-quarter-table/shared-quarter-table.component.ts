...
export class SharedQuarterTableComponent {
  ...
  constructor(private route: ActivatedRoute, private authService: LoginService,
    ...
    private companyServices: CompanyHomeService,private sectorsAndActivitiesServices: SectorAndActivitiesService, private auditRuleHomeService: AuditRuleHomeService) {
